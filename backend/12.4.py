"""
TrackTM Import - Day 10: 12/4/2025 (Thursday)
Job 2507 - PNSY DD #2 Stairwells T&M

Based on timesheet showing:
- Date: 12/4/25 THURSDAY
- 6 workers - regular crew
...
- Work Areas: Stairwell A (South) - Remove Tape & Overspray Protection
              Adjacent to areas receiving overcoat of Acrolon 100
              Touch-up areas where tape removed to expose underlying fireproofing
"""
...
ENTRY_DATA = {
    ...
    # Materials: 8 GAL Acrolon 100
    # Consumables: 3 Box 1" Brushes, 1 Pack Roller Naps, 1 Box AAA Batteries (8 Packs)
    # PPE: 2 Sets Vapor Cartridges, 5 Pair (blank - assuming coveralls/gloves),
    #      1 Box Rubber Gloves, 5 Pair Work Gloves, 4 Pair P100 Dust Filters
    # Fuel: 22.5 Gas (gallon)
    "materials": [
        # Materials section
        {"name": "Acrolon Paint", "quantity": 8},  # 8 GAL ACROLON 100
        # Consumables
        {"name": "Bent Rad Brush 1 Inch", "quantity": 3},  # 3 BOX 1" BRUSHES
        {"name": "PAK Roller Naps", "quantity": 1},  # 1 PACK ROLLER NAPS
        {"name": "AAA Batteries", "quantity": 1},  # 1 BOX AAA BATTERIES (8 PACKS)
        # PPE
        {
            "name": "Organic Vapor Cartridge 6001",
            "quantity": 2,
        },  # 2 SETS VAPOR CARTRIDGES
        {"name": "Coveralls 2XL", "quantity": 5},  # 5 PAIR (assuming coveralls)
        {
            "name": "Gloves Nitrile Latex Disposable",
            "quantity": 6,
        },  # 1 BOX RUBBER + 5 PAIR WORK
        {"name": "P100 Filter Particulate", "quantity": 4},  # 4 PAIR P100 DUST FILTERS
        # Fuel
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("IMPORTING SINGLE DAY: 12/4/2025")
    print("=" * 60)
