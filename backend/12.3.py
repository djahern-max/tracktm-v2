"""
TrackTM Import - Day 9: 12/3/2025 (Wednesday)
Job 2507 - PNSY DD #2 Stairwells T&M

Based on timesheet showing:
- Date: 12/3/25 WEDNESDAY
- 6 workers - back to regular crew size
...
- Work Areas: Stairwell A (South) - Spray Acrolon 100, General Clean-Up
"""
...
ENTRY_DATA = {
    ...
    # Materials: 5A GAL (assuming 5 gallons) Acrolon 100
    # Consumables: 1 Box 1" Brushes, 1 Pack Roller Naps, 5 Roller Handles,
    #              1 Box AAA Batteries (8 Packs), 5 5Gal Bucket Liners, 5 5Gal Buckets
    # PPE: 5 Vapor Cartridges, 1 Box Rubber Gloves, 5 Pair Work Gloves
    # Fuel: 10 Gas (gallon)
    "materials": [
        # Materials section
        {"name": "Acrolon Paint", "quantity": 5},  # 5A GAL ACROLON 100
        # Consumables
        {"name": "Bent Rad Brush 1 Inch", "quantity": 1},  # 1 BOX 1" BRUSHES
        {"name": "PAK Roller Naps", "quantity": 1},  # 1 PACK ROLLER NAPS
        {"name": 'Roller Frame Mini 4"', "quantity": 5},  # 5 ROLLER HANDLES
        {"name": "AAA Batteries", "quantity": 1},  # 1 BOX AAA BATTERIES (8 PACKS)
        {"name": "Bucket Liners 5 Gallon", "quantity": 5},  # 5 5GAL BUCKET LINERS
        {"name": "5 Gallon Buckets", "quantity": 5},  # 5 5GAL BUCKETS
        # PPE
        {"name": "Organic Vapor Cartridge 6001", "quantity": 5},  # 5 VAPOR CARTRIDGES
        {
            "name": "Gloves Nitrile Latex Disposable",
            "quantity": 6,
        },  # 1 BOX RUBBER GLOVES + 5 PAIR WORK GLOVES
        # Fuel
        {"name": "Gasoline", "quantity": 10},  # 10 GAL Gas
    ],
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("IMPORTING SINGLE DAY: 12/3/2025")
    print("=" * 60)
