"""
TrackTM Import - Day 12: 12/9/2025 (Tuesday) - FINAL DAY
Job 2507 - PNSY DD #2 Stairwells T&M

Based on timesheet showing:
- Date: 12/9/25 TUESDAY - FINAL DAY
- 5 workers - small crew for final cleanup
- Justin Kneeland: PS/FM - 10 hrs straight, 10 hrs OT (0600-1200) = 10 + 10 = 20 total
- Tim Mladek, Tom Guy, Fred Angelosanto, Marineide Dantas: all with checkmarks
- Work Areas: Stairwell A (South) - Remove plastic & overspray protection on Level 1 & 2
              Clean up fall out debris
- Week Beg: 12/8 TO Week End: 12/14
"""
...
# ============================================
# Day 12: Tuesday 12/9/2025 - FINAL DAY
# 5 workers - final cleanup crew
# Justin Kneeland: PS/FM - 10 reg + 10 OT = 20 hours
# Others: checkmarks showing 10 hours each
# Work: Final cleanup - removing plastic/overspray protection, debris
# ============================================

ENTRY_DATA = {
    "job_number": "2507",
    "date": "2025-12-09",
    # LABOR - 5 workers (final day cleanup)
    ...
    # Consumables: 4 Pair P100 Dust Filters
    # PPE: 5 Pair Work Gloves, 4 Tyvek Suits
    # Fuel: 20 Gas (gallon)
    "materials": [
        # Consumables
        ...
        {"name": "Coveralls 2XL", "quantity": 4},  # 4 TYVEK SUITS
        # Fuel
        {"name": "Gasoline", "quantity": 20},  # 20 GAL Gas
    ],
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("IMPORTING FINAL DAY: 12/9/2025")
    print("=" * 60)

    if import_timesheet_entry(ENTRY_DATA):
        print("\n✅ Import successful!")
        print("\n🎉 PROJECT COMPLETE - All timesheets imported!")
    else:
        print("\n❌ Import failed!")
