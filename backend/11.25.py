"""
TrackTM Import - Day 7: 11/25/2025 (Tuesday)
Job 2507 - PNSY DD #2 Stairwells T&M

Based on timesheet showing:
- Date: 11/25/25 TUESDAY
- 6 workers back to full crew
- Justin Kneeland: PS/FM - 10 hrs straight
- Tim Mladek, Ed Guy, Tom Guy, Fred Angelosanto, Marineide Dantas: all with checkmarks
- Work Areas: Stairwell B - Remove overspray protection & plastic from scaffold decks and floors
              Clean up debris inside containments & any debris outside containment
"""
...
ENTRY_DATA = {
    ...
    # Materials: Gallon Acrolon 100 (1)
    # Consumables: Pair P100 Filters (3), Jar Liners (5), 5 Gallon Liner (1),
    #              Pair Roller Naps (1), Roller Frames (4), Box Radiator Brushes (1),
    #              Inspection Mirrors (4), Box AAA Batteries (1)
    # PPE: Tyvek Coveralls (5), Pair Gloves (5), Head Socks (4)
    "materials": [
        # Materials section
        {"name": "Acrolon Paint", "quantity": 1},  # GALLON ACROLON 100
        # Consumables
        {"name": "P100 Filter Particulate", "quantity": 3},  # PAIR P100 FILTERS (3)
        {"name": "Jar Liners", "quantity": 5},  # JAR LINERS (5)
        {"name": "Bucket Liners 5 Gallon", "quantity": 1},  # 5 GALLON LINER
        {"name": "PAK Roller Naps", "quantity": 1},  # PAIR ROLLER NAPS
        {"name": 'Roller Frame Mini 4"', "quantity": 4},  # ROLLER FRAMES (4)
        {"name": "Bent Rad Brush 1 Inch", "quantity": 1},  # BOX RADIATOR BRUSHES
        {"name": "Telescopic Mirror", "quantity": 4},  # INSPECTION MIRRORS (4)
        {"name": "AAA Batteries", "quantity": 1},  # BOX AAA BATTERIES
        # PPE
        {"name": "Coveralls 2XL", "quantity": 5},  # TYVEK COVERALLS (5)
        {"name": "Gloves Nitrile Latex Disposable", "quantity": 5},  # PAIR GLOVES (5)
        {"name": "Head Socks", "quantity": 4},  # HEAD SOCKS (4)
    ],
    # EQUIPMENT - From timesheet page 2
    "equipment": [
        {"name": "Ford F250", "quantity": 1, "rate_period": "daily"},
        {"name": "Joe Blaster", "quantity": 1, "rate_period": "daily"},
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("IMPORTING SINGLE DAY: 11/25/2025")
    print("=" * 60)
